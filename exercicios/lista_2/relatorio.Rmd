...
Objetivo: O principal objetivo desta lista de exercícios é fixar conceitos vistos em sala de aula sobre hierarquias de memória, em particular com relação a memórias cache.
...
A Tabela abaixo apresenta as mudanças da memória Cache frente a cada um dos acessos de memória realizados. Para o entendimento da atividade, uma representação gráfica \footnote{Disponível em: } também foi criada
...
A determinação do *hit-ration* é defina da seguinte forma

<center>
$$
hit\_ration = \frac{hit_{total}}{acesso_{total}}
$$
</center>

Com isto, o *hit\_ration* deste exercício é

$$
hit\_ration = \frac{5}{20} = 0.25 \ ou \ 25\%
$$
...
- c. Qual das versoes acima do programa (isto é, com loops i/jou j/i)  roda mais rapidamente? Explique a razão para que isto ocorra.
